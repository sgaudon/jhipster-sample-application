...
import { JhipsterSessionHoucheApplicationTestModule } from '../../../test.module';
    ...
    describe('Alert Error Component', () => {
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [JhipsterSessionHoucheApplicationTestModule],
        ...
        describe('Error Handling', () => {
            it('Should display an alert on status 0', () => {
                // GIVEN
                eventManager.broadcast({ name: 'jhipsterSessionHoucheApplicationApp.httpError', content: { status: 0 } });
                // THEN
            ...
            it('Should display an alert on status 404', () => {
                // GIVEN
                eventManager.broadcast({ name: 'jhipsterSessionHoucheApplicationApp.httpError', content: { status: 404 } });
                // THEN
                expect(comp.alerts.length).toBe(1);
            ...
            it('Should display an alert on generic error', () => {
                ...
                eventManager.broadcast({
                    name: 'jhipsterSessionHoucheApplicationApp.httpError',
            ...
            it('Should display an alert on status 400 for generic error', () => {
                ...
                eventManager.broadcast({ name: 'jhipsterSessionHoucheApplicationApp.httpError', content: response });
                // THEN
                expect(comp.alerts.length).toBe(1);
